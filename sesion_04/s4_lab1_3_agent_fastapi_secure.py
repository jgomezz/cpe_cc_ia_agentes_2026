...
API_KEY = os.getenv("AGENT_API_KEY", "dev-key-123")
...
async def chat(request: ChatRequest, api_key: str = Security(verify_api_key)) -> ChatResponse:   
    """Endpoint para recibir mensajes y responder usando el agente. Requiere header X-API-Key."""
